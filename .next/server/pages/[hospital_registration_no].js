...
const HospitalInfo = ({
  ...
  "https://www.google.com/maps/embed/v1/place?key=" + process.env.NEXT_PUBLIC_GMAPS_KEY + "&q=" + hospital.hospital_name.replace(/ /g, "+") + "&zoom=16" : "https://www.google.com/maps/embed/v1/place?key=" + process.env.NEXT_PUBLIC_GMAPS_KEY + "&q=" + hospital.address.latitude + "," + hospital.address.longitude + "&zoom=16",
        {
    0: mapSrc,
    1: setMapSrc
        ...
        children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx("h4", {
          ...
          children: ["ward", "special_ward", "cabin", "vip_cabin", "icu", "ccu", "hdu", "hfncu", "emergency", "covidu", "extra"].map((bedType, key) => {
            return hospital.vacant_bed_log[bedType] == null ? null : /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx("div", {
              className: " d-flex justify-content-center align-items-center col p-1 ",
            ...
            children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx("input", {
              ...
              onChange: e => {
                navigator.geolocation ? navigator.geolocation.getCurrentPosition(position => {
                  ...
                  "https://www.google.com/maps/embed/v1/directions?key=" + process.env.NEXT_PUBLIC_GMAPS_KEY + "&origin=" + position.coords.latitude + "," + position.coords.longitude + "&destination=" + hospital.hospital_name.replace(/ /g, "+") + "&mode=driving&units=metric" : "https://www.google.com/maps/embed/v1/directions?key=" + process.env.NEXT_PUBLIC_GMAPS_KEY + "&origin=" + position.coords.latitude + "," + position.coords.longitude + "&destination=" + hospital.address.latitude + "," + hospital.address.longitude + "&mode=driving&units=metric") : setMapSrc(placeModeMapSrc);
