...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res) => {
  ...
  return res.status(200).json(await _functionalities_DB_prismaInstance__WEBPACK_IMPORTED_MODULE_0__/* .prisma.booking.create */ ._.booking.create({
    data: (0,_functionalities_mutateObjects__WEBPACK_IMPORTED_MODULE_1__/* .mutateContactNumber */ .D)(req.body, true)
  }));
...
var __webpack_exports__ = __webpack_require__.X(0, [4394], () => (__webpack_exec__(4618)));
