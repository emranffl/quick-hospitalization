...
var exports = {};
exports.id = 8678;
exports.ids = [8678,2218,2643,3918];
exports.modules = {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res) => {
  ...
  if (req.headers["x-service-type"] === "general_service") {
    ...
    return res.status(200).json(await _functionalities_DB_prismaInstance__WEBPACK_IMPORTED_MODULE_0__/* .prisma.general_service.update */ ._.general_service.update({
      where: {
    ...
    console.log(req.headers["x-service-type"], req.body);
    return res.status(200).json(await _functionalities_DB_prismaInstance__WEBPACK_IMPORTED_MODULE_0__/* .prisma.blood_analytical_service.update */ ._.blood_analytical_service.update({
      where: {
        registration_no: req.body["registration_no"]
      },
      data: req.body
    ...
    console.log(req.headers["x-service-type"], req.body);
    return res.status(200).json(await _functionalities_DB_prismaInstance__WEBPACK_IMPORTED_MODULE_0__/* .prisma.diagnostic_imaging_service.update */ ._.diagnostic_imaging_service.update({
      where: {
        registration_no: req.body["registration_no"]
      },
      data: req.body
...
var __webpack_exports__ = (__webpack_exec__(9960));
